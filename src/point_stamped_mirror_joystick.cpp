...
///
/// @section Parameters
///  `~/control_enabled (std::string) [default "UNUSED"]`      - The name of the controller input that will control its respective function
...
int main(int argc, char * argv[])
{
    ...
    // Publisher
    auto pos_pub = node->create_publisher<geometry_msgs::msg::PointStamped>("desired_position", 100); // puhlishing rate has to be 100, otherwise delta displays incorrect behaviour
